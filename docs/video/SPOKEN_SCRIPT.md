...
*Per-block on-screen plan: [`BLOCK_PRESENTATION.md`](BLOCK_PRESENTATION.md). Next: [`PREFLIGHT_CHECKLIST.md`](PREFLIGHT_CHECKLIST.md), [`RECORDING_GUIDE.md`](RECORDING_GUIDE.md).*
