...
| **`viva/`** | Viva master brief, **`VIVA_SESSION_RULES.md`** (15 min, camera, recording, no slides), printable cheatsheet, **all-phase coach**, **`supervisor_share/`**, **`supervisor_meeting_bundle/`**. |
