...
| **Meeting checklist** | [`docs/reports/SUPERVISOR_FINAL_FEEDBACK.md`](../docs/reports/SUPERVISOR_FINAL_FEEDBACK.md) | Your own prompts and evidence map (keep private if you prefer). |
...
| [`docs/planning/`](../docs/planning/) | Personal roadmap / publication notes; fine for you, rarely needed live. |
