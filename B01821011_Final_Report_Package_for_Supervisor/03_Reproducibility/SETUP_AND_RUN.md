...
Reads `Dissertation_Arka_Talukder.md`, produces `Arka_Talukder_Dissertation_Final.docx`. See **`docs/reports/FINAL_REPORT_GENERATION.md`** in the full repository for full procedure.
